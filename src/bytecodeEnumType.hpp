...
typedef unsigned short bytecode_t;

//Typedef datasize for later flexibility
typedef int wordwidth_t;

//Typedef opcode size for later flexibility
typedef char registersize_t;

typedef char operationsize_t;

typedef char immediatesize_t;
